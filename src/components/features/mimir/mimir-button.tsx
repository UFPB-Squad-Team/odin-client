...
export function MimirButton() {
  ...
  return (
    ...
    >
      ...
      <span
        className={`absolute -top-10 right-0 whitespace-nowrap rounded-md border border-zinc-200 bg-white px-2.5 py-1 text-xs font-medium text-zinc-700 shadow-sm transition-all duration-200 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 ${
          hovered
