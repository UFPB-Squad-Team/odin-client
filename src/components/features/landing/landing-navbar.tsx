      ...
      <PageContainer className="flex h-16 items-center justify-between gap-4 sm:h-[4.5rem]">
        ...
        >
          ...
          <a
            id="tour-governanca"
            href="#governanca"
            className="hidden rounded-md px-3 py-2 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100 dark:text-zinc-200 dark:hover:bg-zinc-900 md:inline-flex"
          >
            Governança
          </a>
