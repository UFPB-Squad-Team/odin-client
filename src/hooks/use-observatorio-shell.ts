  ...
  function selectEntity(entity: MapEntity) {
    if (entity.kind === "municipio") {
      setSelected({
        ...
        metrics: [
          { label: "Bairros mapeados", value: String(bairros.length) },
          { label: "Escolas no recorte", value: String(escolas.length) },
        ],
      });
    }
    ...
    if (entity.kind === "bairro") {
      setSelected({
        ...
        metrics: [
          { label: "Escolas no bairro", value: String(escolas.length) },
